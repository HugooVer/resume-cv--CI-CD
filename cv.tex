...
\newcommand{\nom}{\detokenize{${NAME}}}
\newcommand{\poste}{Ingénieur DevOps / SRE}
...
\else
    ...
    \newcommand{\makecvheader}{
      \begin{minipage}[t]{0.6\textwidth}
        {\huge \textbf{\nom}}\\[0.2em]
        {\large \poste}\\[0.5em]
        \textit{Disponible immédiatement | Ouvert à un premier CDI ou Stage de 6 mois}
      \end{minipage}
      \hfill
...
\cvsection{Objectif}
Étudiant à l'école \textbf{42 Paris}, (titre RNCP 7 en cours).  Passionné par l’automatisation et la culture 'Everything as Code', je souhaite mettre mes compétences en administration système et CI/CD au service d'une équipe de production en CDI ou en stage de fin d'études.

\cvsection{Projets}
\textbf{\href{https://github.com/HugooVer/my-vps}{Infrastructure Personnelle} + \href{https://github.com/HugooVer/Resume-CI-CD}{Déploiement Continu (VPS + CI/CD)}}.\\
